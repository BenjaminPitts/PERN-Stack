class App extends React.Component {
    ...
    componentDidMount = () => {
        axios.get('https://pern-test0987654321.herokuapp.com/').then(
            (response) => {
                this.setState({
    ...
    createPerson = (event) => {
        ...
        axios.post(
            'https://pern-test0987654321.herokuapp.com/',
            {
    ...
    deletePerson = (event) => {
        axios.delete('https://pern-test0987654321.herokuapp.com/' + event.target.value).then(
            (response) => {
                this.setState({
                    people:response.data
                })
    ...
    updatePerson = (event) => {
        ...
        axios.put(
            'https://pern-test0987654321.herokuapp.com/' + id,
            {
